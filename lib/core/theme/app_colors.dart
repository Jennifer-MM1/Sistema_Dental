...
class AppColors {
  ...
  static const Color primaryBlue = Color(0xFF006C9C); // Color principal para botones y headers
  static const Color secondaryBlue = Color(0xFF00537A); // Azul más oscuro
  static const Color lightBlueAccent = Color(0xFFBBE5F6); // Azul claro para selección
